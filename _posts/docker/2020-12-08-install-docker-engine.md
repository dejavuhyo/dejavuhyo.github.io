...
### 1) .rpm 파일 다운로드
[https://download.docker.com/linux/centos/](https://download.docker.com/linux/centos/) CentOS 버전을 선택하고, 설치하려는 Docker 버전 x86_64/stable/Packages/ 경로의 .rpm 파일을 다운로드 한다.
